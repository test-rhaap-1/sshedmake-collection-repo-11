"""A hello-world filter plugin in sshedmake_namespace_11.myrhdh_11."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_11 Myrhdh_11
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_11.myrhdh_11.hello_world }}"
"""
